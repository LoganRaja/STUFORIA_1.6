...
public class CoverImageAdapter extends BaseAdapter {
	...
	private Integer[] mImageIds = { R.drawable.coverflow_image1,
			R.drawable.coverflow_image2, R.drawable.coverflow_image3,
			R.drawable.coverflow_image4, R.drawable.coverflow_image5};
