...
public class Banking extends ActionBarActivity {

    ViewPager pager;
    ViewPagerAdapterBanking adapter;
    SlidingTabLayout bankingtabs;
    CharSequence Titles[]={"Apply education loan","    Document to be submitted   ","Rate of interest"};
    int Numboftabs =3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bankingtabs.setViewPager(pager);
    }
