 ...
 */
public class VisaProcessingF1 extends Fragment {

    public VisaProcessingF1() {
        // Required empty public constructor
    }
    Button uploadpass,uploadi20;
    String id;
    JustifiedTextView justified;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visa_f1_try, container, false);
        justified=(JustifiedTextView) getActivity().findViewById(R.id.justified);
